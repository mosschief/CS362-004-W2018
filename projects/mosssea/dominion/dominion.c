...
int adventurerPlay(int choice1, int choice2, int choice3, struct gameState* state, int handPos, int* bonus){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
        return adventurerPlay(choice1, choice2, choice3, state, handPos, bonus);
